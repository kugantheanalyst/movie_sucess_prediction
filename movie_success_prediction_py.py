...
corr = data.drop(columns=['imdb_binned']).corr() # Drop the 'imdb_binned' column before calculating correlation
...
# Access the cross-validation scores using 'cv_results_' and the appropriate key
